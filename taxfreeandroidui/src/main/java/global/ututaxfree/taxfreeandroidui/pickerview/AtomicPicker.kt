 ...
 */
class AtomicPicker : View {
    private val executorService: ScheduledExecutorService
    private var scheduledFuture: ScheduledFuture<*>? = null
    private var loopScrollListener: LoopScrollListener? = null
    private val onGestureListener: SimpleOnGestureListener
    ...
    constructor(
        ...
        localHandler = Handler(`AtomicPicker$$Lambda$1`.`lambdaFactory$`(this))
    ...
    private fun itemSelected() {
        if (loopScrollListener != null) {
            postDelayed(`AtomicPicker$$Lambda$3`.`lambdaFactory$`(this), 200L)
        }
    }
    ...
    internal inner class WheelViewGestureListener : SimpleOnGestureListener() {
        ...
        override fun onFling(
            ...
            this@AtomicPicker.startSmoothScrollTo(velocityY)
