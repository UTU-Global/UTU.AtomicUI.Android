...
public class AtomicSwitch extends View implements Checkable {
    ...
    public AtomicSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    public AtomicSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }
    @TargetApi(23)
    public AtomicSwitch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.AtomicSwitch);
        }

        shadowEffect = optBoolean(typedArray,
                R.styleable.AtomicSwitch_sb_shadow_effect,
                true);

        uncheckCircleColor = optColor(typedArray,
                R.styleable.AtomicSwitch_sb_uncheckcircle_color,
                0XffAAAAAA);//0XffAAAAAA;

        uncheckCircleWidth = optPixelSize(typedArray,
                R.styleable.AtomicSwitch_sb_uncheckcircle_width,
                dp2pxInt(1.5f));//dp2pxInt(1.5f);

        uncheckCircleOffsetX = dp2px(10);

        uncheckCircleRadius = optPixelSize(typedArray,
                R.styleable.AtomicSwitch_sb_uncheckcircle_radius,
                dp2px(4));//dp2px(4);
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(AtomicSwitch view, boolean isChecked);
    }
